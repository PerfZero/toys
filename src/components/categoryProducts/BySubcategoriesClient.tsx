...
/**
 * Клиентский остров страницы подкатегории (/subcat/:id).
 *
 ...
 */
function BySubcategoriesClient({ initialProducts, id }: { initialProducts: any[]; id: string }) {
...
export default BySubcategoriesClient;
