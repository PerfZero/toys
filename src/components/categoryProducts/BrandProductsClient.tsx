...
/**
 * Клиентский остров страницы бренда (/brand/:id).
 *
 ...
 */
function BrandProductsClient({ initialProducts, id }: { initialProducts: any[]; id: string }) {
  ...
  const [categoryName, setCategoryName] = useState(
    initialProducts[0]?.tradeMarkName || "",
  );
